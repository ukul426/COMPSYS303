...
<#macro simulation_body position>
    ...
    private static void receiveVariables() {
        try {
            ...
            // Receive AR
            if (json.has("AR")) {
                ${tickdata_name}.AR = json.getBoolean("AR");
            }
            // Receive A_event
            if (json.has("A_event")) {
            ...
            // Receive VR
            if (json.has("VR")) {
                ${tickdata_name}.VR = json.getBoolean("VR");
            }
            // Receive V_event
            if (json.has("V_event")) {
            ...
            if (json.has("_Pacemaker_local__Atrig10")) {
                ${tickdata_name}._Pacemaker_local__Atrig10 = json.getBoolean("_Pacemaker_local__Atrig10");
            }
            // Receive _Pacemaker_local__Atrig11
            if (json.has("_Pacemaker_local__Atrig11")) {
                ${tickdata_name}._Pacemaker_local__Atrig11 = json.getBoolean("_Pacemaker_local__Atrig11");
            }
            ...
            if (json.has("_g117_e1")) {
                ${tickdata_name}._g117_e1 = json.getBoolean("_g117_e1");
            }
            // Receive _g118
            if (json.has("_g118")) {
            ...
            if (json.has("_g126_e2")) {
                ${tickdata_name}._g126_e2 = json.getBoolean("_g126_e2");
            }
            // Receive _g127
            if (json.has("_g127")) {
            ...
            if (json.has("_g144_e1")) {
                ${tickdata_name}._g144_e1 = json.getBoolean("_g144_e1");
            }
            // Receive _g145
            if (json.has("_g145")) {
            ...
            if (json.has("_g153_e2")) {
                ${tickdata_name}._g153_e2 = json.getBoolean("_g153_e2");
            }
            // Receive _g154
            if (json.has("_g154")) {
            ...
            // Receive _g37_e1
            if (json.has("_g37_e1")) {
                ${tickdata_name}._g37_e1 = json.getBoolean("_g37_e1");
            }
            // Receive _g38
            if (json.has("_g38")) {
            ...
            // Receive _g46_e2
            if (json.has("_g46_e2")) {
                ${tickdata_name}._g46_e2 = json.getBoolean("_g46_e2");
            }
            // Receive _g47
            if (json.has("_g47")) {
            ...
            // Receive _g66_e1
            if (json.has("_g66_e1")) {
                ${tickdata_name}._g66_e1 = json.getBoolean("_g66_e1");
            }
            // Receive _g67
            if (json.has("_g67")) {
            ...
            // Receive _g99_e2
            if (json.has("_g99_e2")) {
                ${tickdata_name}._g99_e2 = json.getBoolean("_g99_e2");
            }
            // Receive _g9_e1
            if (json.has("_g9_e1")) {
            ...
            // Receive _pg202
            if (json.has("_pg202")) {
                ${tickdata_name}._pg202 = json.getBoolean("_pg202");
            }
            // Receive _pg29
            if (json.has("_pg29")) {
            ...
            if (json.has("_pg37_e1")) {
                ${tickdata_name}._pg37_e1 = json.getBoolean("_pg37_e1");
            }
            // Receive _pg49
            if (json.has("_pg49")) {
            ...
            // Receive _pg9_e1
            if (json.has("_pg9_e1")) {
                ${tickdata_name}._pg9_e1 = json.getBoolean("_pg9_e1");
            }
            // Receive _pre_AP
            if (json.has("_pre_AP")) {
            ...
            if (json.has("_region0_AVI_timer_t")) {
                ${tickdata_name}._region0_AVI_timer_t = json.getDouble("_region0_AVI_timer_t");
            }
            // Receive _region1_PVARP_timer_t
            if (json.has("_region1_PVARP_timer_t")) {
                ${tickdata_name}._region1_PVARP_timer_t = json.getDouble("_region1_PVARP_timer_t");
            }
            // Receive _region2_VRP_timer_t
            if (json.has("_region2_VRP_timer_t")) {
                ${tickdata_name}._region2_VRP_timer_t = json.getDouble("_region2_VRP_timer_t");
            }
            // Receive _region3_AEI_timer_t
            if (json.has("_region3_AEI_timer_t")) {
                ${tickdata_name}._region3_AEI_timer_t = json.getDouble("_region3_AEI_timer_t");
            }
            // Receive _region4_LRI_timer_t
            if (json.has("_region4_LRI_timer_t")) {
                ${tickdata_name}._region4_LRI_timer_t = json.getDouble("_region4_LRI_timer_t");
            }
            // Receive _region5_URI_timer_t
            if (json.has("_region5_URI_timer_t")) {
                ${tickdata_name}._region5_URI_timer_t = json.getDouble("_region5_URI_timer_t");
            }
            ...
            if (json.has("inside_URI")) {
                ${tickdata_name}.inside_URI = json.getBoolean("inside_URI");
            }
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private static void sendVariables() {
        ...
        // Send AR
        json.put("AR", JSONObject.wrap(${tickdata_name}.AR));
        // Send A_event
        json.put("A_event", JSONObject.wrap(${tickdata_name}.A_event));
        // Send VR
        json.put("VR", JSONObject.wrap(${tickdata_name}.VR));
        // Send V_event
        ...
        json.put("_Pacemaker_local__Atrig10", JSONObject.wrap(${tickdata_name}._Pacemaker_local__Atrig10));
        // Send _Pacemaker_local__Atrig11
        json.put("_Pacemaker_local__Atrig11", JSONObject.wrap(${tickdata_name}._Pacemaker_local__Atrig11));
        ...
        // Send _g117_e1
        json.put("_g117_e1", JSONObject.wrap(${tickdata_name}._g117_e1));
        // Send _g118
        ...
        // Send _g126_e2
        json.put("_g126_e2", JSONObject.wrap(${tickdata_name}._g126_e2));
        // Send _g127
        ...
        // Send _g144_e1
        json.put("_g144_e1", JSONObject.wrap(${tickdata_name}._g144_e1));
        // Send _g145
        ...
        // Send _g153_e2
        json.put("_g153_e2", JSONObject.wrap(${tickdata_name}._g153_e2));
        // Send _g154
        ...
        // Send _g37_e1
        json.put("_g37_e1", JSONObject.wrap(${tickdata_name}._g37_e1));
        // Send _g38
        ...
        // Send _g46_e2
        json.put("_g46_e2", JSONObject.wrap(${tickdata_name}._g46_e2));
        // Send _g47
        ...
        // Send _g66_e1
        json.put("_g66_e1", JSONObject.wrap(${tickdata_name}._g66_e1));
        // Send _g67
        ...
        // Send _g99_e2
        json.put("_g99_e2", JSONObject.wrap(${tickdata_name}._g99_e2));
        // Send _g9_e1
        ...
        // Send _pg202
        json.put("_pg202", JSONObject.wrap(${tickdata_name}._pg202));
        // Send _pg29
        json.put("_pg29", JSONObject.wrap(${tickdata_name}._pg29));
        // Send _pg37_e1
        json.put("_pg37_e1", JSONObject.wrap(${tickdata_name}._pg37_e1));
        // Send _pg49
        ...
        // Send _pg9_e1
        json.put("_pg9_e1", JSONObject.wrap(${tickdata_name}._pg9_e1));
        // Send _pre_AP
        ...
        json.put("_region0_AVI_timer_t", JSONObject.wrap(${tickdata_name}._region0_AVI_timer_t));
        // Send _region1_PVARP_timer_t
        json.put("_region1_PVARP_timer_t", JSONObject.wrap(${tickdata_name}._region1_PVARP_timer_t));
        // Send _region2_VRP_timer_t
        json.put("_region2_VRP_timer_t", JSONObject.wrap(${tickdata_name}._region2_VRP_timer_t));
        // Send _region3_AEI_timer_t
        json.put("_region3_AEI_timer_t", JSONObject.wrap(${tickdata_name}._region3_AEI_timer_t));
        // Send _region4_LRI_timer_t
        json.put("_region4_LRI_timer_t", JSONObject.wrap(${tickdata_name}._region4_LRI_timer_t));
        // Send _region5_URI_timer_t
        json.put("_region5_URI_timer_t", JSONObject.wrap(${tickdata_name}._region5_URI_timer_t));
        // Send _taken_transitions
        json.put("_taken_transitions", JSONObject.wrap(${tickdata_name}._taken_transitions));
        // Send inside_URI
        json.put("inside_URI", JSONObject.wrap(${tickdata_name}.inside_URI));
