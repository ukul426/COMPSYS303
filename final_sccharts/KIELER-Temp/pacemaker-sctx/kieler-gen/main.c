...
void receiveVariables() {
    ...
    if(root != NULL) {
        ...
        if(item != NULL) {
            model._pg139 = item->valueint;
        }
        // Receive _pg143
        item = cJSON_GetObjectItemCaseSensitive(root, "_pg143");
        if(item != NULL) {
            model._pg143 = item->valueint;
        }
        // Receive _pg145
        ...
        if(item != NULL) {
            model._pg157 = item->valueint;
        }
        // Receive _pg202
        item = cJSON_GetObjectItemCaseSensitive(root, "_pg202");
        if(item != NULL) {
            model._pg202 = item->valueint;
        }
        // Receive _pg29
        ...
        if(item != NULL) {
            model.inside_URI = item->valueint;
        }
    }
...
void sendVariables(int send_interface) {
    ...
    // Send A_event
    cJSON_AddItemToObject(root, "A_event", cJSON_CreateBool(model.A_event));
    // Send VR
    cJSON_AddItemToObject(root, "VR", cJSON_CreateBool(model.VR));
    // Send V_event
    cJSON_AddItemToObject(root, "V_event", cJSON_CreateBool(model.V_event));
    // Send _GO
    ...
    // Send _g117_e1
    cJSON_AddItemToObject(root, "_g117_e1", cJSON_CreateBool(model._g117_e1));
    // Send _g118
    ...
    // Send _g126_e2
    cJSON_AddItemToObject(root, "_g126_e2", cJSON_CreateBool(model._g126_e2));
    // Send _g127
    ...
    // Send _g144_e1
    cJSON_AddItemToObject(root, "_g144_e1", cJSON_CreateBool(model._g144_e1));
    // Send _g145
    ...
    // Send _g153_e2
    cJSON_AddItemToObject(root, "_g153_e2", cJSON_CreateBool(model._g153_e2));
    // Send _g154
    ...
    // Send _g19_e2
    cJSON_AddItemToObject(root, "_g19_e2", cJSON_CreateBool(model._g19_e2));
    // Send _g20
    ...
    // Send _g46_e2
    cJSON_AddItemToObject(root, "_g46_e2", cJSON_CreateBool(model._g46_e2));
    // Send _g47
    ...
    // Send _g66_e1
    cJSON_AddItemToObject(root, "_g66_e1", cJSON_CreateBool(model._g66_e1));
    // Send _g67
    ...
    // Send _g89_e1
    cJSON_AddItemToObject(root, "_g89_e1", cJSON_CreateBool(model._g89_e1));
    // Send _g9
    ...
    // Send _g99_e2
    cJSON_AddItemToObject(root, "_g99_e2", cJSON_CreateBool(model._g99_e2));
    // Send _g9_e1
    ...
    // Send _pg139
    cJSON_AddItemToObject(root, "_pg139", cJSON_CreateBool(model._pg139));
    // Send _pg143
    cJSON_AddItemToObject(root, "_pg143", cJSON_CreateBool(model._pg143));
    // Send _pg145
    cJSON_AddItemToObject(root, "_pg145", cJSON_CreateBool(model._pg145));
    // Send _pg148
    cJSON_AddItemToObject(root, "_pg148", cJSON_CreateBool(model._pg148));
    // Send _pg154
    ...
    // Send _pg157
    cJSON_AddItemToObject(root, "_pg157", cJSON_CreateBool(model._pg157));
    // Send _pg202
    cJSON_AddItemToObject(root, "_pg202", cJSON_CreateBool(model._pg202));
    // Send _pg29
    ...
    // Send _pg9_e1
    cJSON_AddItemToObject(root, "_pg9_e1", cJSON_CreateBool(model._pg9_e1));
    // Send _pre_AP
    ...
    cJSON_AddItemToObject(root, "_region0_AVI_timer_t", cJSON_CreateNumber(model._region0_AVI_timer_t));
    // Send _region1_PVARP_timer_t
    cJSON_AddItemToObject(root, "_region1_PVARP_timer_t", cJSON_CreateNumber(model._region1_PVARP_timer_t));
    // Send _region2_VRP_timer_t
    cJSON_AddItemToObject(root, "_region2_VRP_timer_t", cJSON_CreateNumber(model._region2_VRP_timer_t));
    // Send _region3_AEI_timer_t
    cJSON_AddItemToObject(root, "_region3_AEI_timer_t", cJSON_CreateNumber(model._region3_AEI_timer_t));
    // Send _region4_LRI_timer_t
    cJSON_AddItemToObject(root, "_region4_LRI_timer_t", cJSON_CreateNumber(model._region4_LRI_timer_t));
    // Send _region5_URI_timer_t
    cJSON_AddItemToObject(root, "_region5_URI_timer_t", cJSON_CreateNumber(model._region5_URI_timer_t));
    ...
    // Send inside_URI
    cJSON_AddItemToObject(root, "inside_URI", cJSON_CreateBool(model.inside_URI));
